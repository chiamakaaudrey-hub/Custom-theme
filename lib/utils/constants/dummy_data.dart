...
class TDummyData {
  ...
  static final List<ProductCategoryModel> productCategories = [
    ...
    ProductCategoryModel(productId: '037', categoryId: '14'),
    ProductCategoryModel(productId: '038', categoryId: '2'),
    ProductCategoryModel(productId: '038', categoryId: '14'),
    ProductCategoryModel(productId: '039', categoryId: '2'),
    ProductCategoryModel(productId: '039', categoryId: '14'),
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      brand: BrandModel(id: '1', name: 'Nike', image: TImages.nikeLogo, isFeatured: true, productsCount: 265),
      ...
      productVariations: [
        ProductVariationModel(
            id: '1', stock: 34, price: 134, salePrice: 122.6, image: TImages.productImage1, description: 'This is a Product description for Green Nike sports shoe.', attributeValues: {'Color': 'Green','Size': 'EU 34'}),
        ProductVariationModel(
    ...
    ProductModel(
        ...
        isFeatured: false,
        thumbnail: TImages.productImage40,
        description: 'This is a product description for a brown leather jacket',
        brand: BrandModel(id: '6', name: 'ZARA', image: TImages.zaraLogo, isFeatured: true, productsCount: 1),
        images: [TImages.productImage21, TImages.productImage9, TImages.productImage2, TImages.productImage4],
        salePrice: 30,
        sku:'ABR4568',
        categoryId: '16',
        productAttributes: [
    ...
    ProductModel(
      ...
      description: 'This is a product description for a t-shirt',
      brand: BrandModel(id: '6', name: 'ZARA', image: TImages.zaraLogo, isFeatured: true, productsCount: 1),
      images: [TImages.productImage4, TImages.productImage6, TImages.productImage4, TImages.productImage6],
      salePrice: 30,
      sku:'ABR4568',
      categoryId: '16',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Red', 'Yellow', 'Green','Blue']),
        ProductAttributeModel(name: 'Size', values: ['EU38', 'EU32', 'EU34']),
      ],
      productVariations: [
        ProductVariationModel(
            id: '1', stock: 34, price: 134, salePrice: 122.6, image: TImages.productImage1, description: 'This is a Product description for 4 Color collar t-shirt dry fit.', attributeValues: {'Color': 'Red','Size': 'EU 34'}),
        ProductVariationModel(
            id: '2', stock: 15, price: 132, image: TImages.productImage23, attributeValues: {'Color': 'Red','Size': 'EU 32'}),
        ProductVariationModel(
            id: '3', stock: 0, price: 234, image: TImages.productImage23, attributeValues: {'Color': 'Yellow','Size': 'EU 34'}),
        ProductVariationModel(
            id: '4', stock: 222, price: 232, image: TImages.productImage1, attributeValues: {'Color': 'Yellow','Size': 'EU 32'}),
        ProductVariationModel(
            id: '5', stock: 0, price: 334, image: TImages.productImage21, attributeValues: {'Color': 'Green','Size': 'EU 34'}),
        ProductVariationModel(
            id: '6', stock: 11, price: 332, image: TImages.productImage21, attributeValues: {'Color': 'Green','Size': 'EU 30'}),
        ProductVariationModel(
            id: '7', stock: 11, price: 332, image: TImages.productImage21, attributeValues: {'Color': 'Blue','Size': 'EU 30'}),
        ProductVariationModel(
            id: '8', stock: 11, price: 332, image: TImages.productImage21, attributeValues: {'Color': 'Blue','Size': 'EU 34'}),
      ],
      productType: 'ProductType.variable',
        ),
    ...
    ProductModel(
        ...
        brand: BrandModel(id: '1', name: 'Nike', image: TImages.nikeLogo, isFeatured: true, productsCount: 265),
        images: [TImages.productImage10, TImages.productImage10, TImages.productImage10, TImages.productImage10],
        salePrice: 30,
        sku: 'ABR4568',
        categoryId: '8',
        productAttributes: [
        ...
        productVariations: [
          ProductVariationModel(
              id: '1', stock: 16, price: 36, salePrice: 12.6, image: TImages.productImage8,
              description: 'Flutter is Googles mobile UI open source framework.', attributeValues: {'Color': 'Orange','Size': 'EU 34'}),
          ProductVariationModel(
              id: '2', stock: 15, price: 35, image: TImages.productImage23, attributeValues: {'Color': 'Black','Size': 'EU 32'}),
          ProductVariationModel(
              id: '3', stock: 0, price: 34, image: TImages.productImage23, attributeValues: {'Color': 'Brown','Size': 'EU 34'}),
          ProductVariationModel(
              id: '4', stock: 222, price: 33, image: TImages.productImage1, attributeValues: {'Color': 'Black','Size': 'EU 34'}),
          ProductVariationModel(
              id: '5', stock: 0, price: 32, image: TImages.productImage21, attributeValues: {'Color': 'Brown','Size': 'EU 32'}),
          ProductVariationModel(
              id: '6', stock: 11, price: 31, image: TImages.productImage21, attributeValues: {'Color': 'Orange','Size': 'EU 32'}),
        ],
        productType: 'ProductType.variable',
    ),
    ProductModel(
        ...
        description: 'Samsung Galaxy S9 (Pink, 64GB) (4GB RAM). Long lasting battery',
        brand: BrandModel(id: '7', name: 'Samsung', image: TImages.appleLogo, isFeatured: true, productsCount: 265),
        images: [TImages.productImage11, TImages.productImage11, TImages.productImage11, TImages.productImage11],
        salePrice: 650,
        sku: 'ABR4568',
        categoryId: '2',
        productAttributes: [
    ...
    ProductModel(
        ...
        brand: BrandModel(id: '7', name: '  Tomi', image: TImages.appleLogo, isFeatured: true, productsCount: 265),
        salePrice: 10,
        sku: 'ABR4568',
        categoryId: '4',
        productAttributes: [
